...
#if !defined (__thekogans_mex_opengl_DepthFunc_h)
#define __thekogans_mex_opengl_DepthFunc_h
...
namespace thekogans {
    namespace mex {
        namespace opengl {
            ...
            public:
                DepthFunc (GLint newDepthFunc_) :
                        newDepthFunc (newDepthFunc_) {
                    glGetIntegerv (GL_DEPTH_FUNC, &oldDepthFunc);
                    if (newDepthFunc != oldDepthFunc) {
                ...
                THEKOGANS_MEX_OPENGL_DISALLOW_COPY_AND_ASSIGN (DepthFunc)
            };
...
#endif // !defined (__thekogans_mex_opengl_DepthFunc_h)
