...
#if !defined (__thekogans_mex_opengl_Version_h)
#define __thekogans_mex_opengl_Version_h
...
namespace thekogans {
    namespace mex {
        namespace opengl {
            ...
            /// \brief
            /// Return the compiled opengl version.
            /// \return Compiled opengl version.
...
#endif // !defined (__thekogans_mex_opengl_Version_h)
