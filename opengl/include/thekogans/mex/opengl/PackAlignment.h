...
#if !defined (__thekogans_mex_opengl_PackAlignment_h)
#define __thekogans_mex_opengl_PackAlignment_h
...
namespace thekogans {
    namespace mex {
        namespace opengl {
            ...
            public:
                explicit PackAlignment (GLint alignment_) :
                ...
                THEKOGANS_MEX_OPENGL_DISALLOW_COPY_AND_ASSIGN (PackAlignment)
            };
...
#endif // !defined (__thekogans_mex_opengl_PackAlignment_h)
