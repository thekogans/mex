...
#if !defined (__thekogans_mex_common_AcceleratorsEditUndoEventHandler_h)
#define __thekogans_mex_common_AcceleratorsEditUndoEventHandler_h
...
namespace thekogans {
    namespace mex {
        namespace common {
            ...
            struct AcceleratorsEditUndoEventHandler : public core::Accelerators::Item::EventHandler {
                AcceleratorsEditUndoEventHandler (core::Module & /*module*/) {}
...
#endif // !defined (__thekogans_mex_common_AcceleratorsEditUndoEventHandler_h)
