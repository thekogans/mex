...
#if !defined (__thekogans_mex_common_MenuBarWindowSpeedBarEventHandler_h)
#define __thekogans_mex_common_MenuBarWindowSpeedBarEventHandler_h
...
namespace thekogans {
    namespace mex {
        namespace common {
            ...
            struct MenuBarWindowSpeedBarEventHandler : public core::MenuBar::Item::ButtonEventHandler {
                core::Module &module;
...
#endif // !defined (__thekogans_mex_common_MenuBarWindowSpeedBarEventHandler_h)
