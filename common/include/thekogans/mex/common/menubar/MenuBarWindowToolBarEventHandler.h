...
#if !defined (__thekogans_mex_common_MenuBarWindowToolBarEventHandler_h)
#define __thekogans_mex_common_MenuBarWindowToolBarEventHandler_h
...
#endif // !defined (__thekogans_mex_common_MenuBarWindowToolBarEventHandler_h)
