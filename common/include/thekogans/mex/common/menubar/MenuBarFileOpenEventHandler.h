...
#if !defined (__thekogans_mex_common_MenuBarFileOpenEventHandler_h)
#define __thekogans_mex_common_MenuBarFileOpenEventHandler_h
...
namespace thekogans {
    namespace mex {
        namespace common {
            ...
            struct MenuBarFileOpenEventHandler : public core::MenuBar::Item::CommandEventHandler {
                core::Module &module;

                explicit MenuBarFileOpenEventHandler (core::Module &module_) :
                    module (module_) {}
...
#endif // !defined (__thekogans_mex_common_MenuBarFileOpenEventHandler_h)
