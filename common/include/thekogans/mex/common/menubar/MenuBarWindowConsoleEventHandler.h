...
#if !defined (__thekogans_mex_common_MenuBarWindowConsoleEventHandler_h)
#define __thekogans_mex_common_MenuBarWindowConsoleEventHandler_h
...
namespace thekogans {
    namespace mex {
        namespace common {
            ...
            struct MenuBarWindowConsoleEventHandler : public core::MenuBar::Item::ButtonEventHandler {
                core::Module &module;
...
#endif // !defined (__thekogans_mex_common_MenuBarWindowConsoleEventHandler_h)
