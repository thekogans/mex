...
#if !defined (__thekogans_mex_common_ToolBarEditUndoEventHandler_h)
#define __thekogans_mex_common_ToolBarEditUndoEventHandler_h
...
namespace thekogans {
    namespace mex {
        namespace common {
            ...
            struct ToolBarEditUndoEventHandler : public core::ToolBar::Item::CommandEventHandler {
                core::Module &module;

                explicit ToolBarEditUndoEventHandler (core::Module &module_) : module (module_) {}
                ...
                virtual void OnUpdateUI (UI &ui) {
                    ui.SetEnabled (core::GetCommandDispatcher ().CanUndo ());
                }
            };
...
#endif // !defined (__thekogans_mex_common_ToolBarEditUndoEventHandler_h)
