...
#if !defined (__thekogans_mex_common_ToolBarPanEventHandler_h)
#define __thekogans_mex_common_ToolBarPanEventHandler_h
...
namespace thekogans {
    namespace mex {
        namespace common {
            ...
            struct _LIB_THEKOGANS_MEX_COMMON_DECL ToolBarPanEventHandler :
                    public core::ToolBar::Item::ToolEventHandler {
                struct _LIB_THEKOGANS_MEX_COMMON_DECL Tool : public core::Tool {
                    THEKOGANS_MEX_CORE_DECLARE_TOOL (ToolBarPanEventHandlerTool)
                ...
                explicit ToolBarPanEventHandler (core::Module &module) :
...
#endif // !defined (__thekogans_mex_common_ToolBarPanEventHandler_h)
