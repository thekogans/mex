...
#if !defined (__thekogans_mex_common_ToolBarZoomInEventHandler_h)
#define __thekogans_mex_common_ToolBarZoomInEventHandler_h
...
namespace thekogans {
    namespace mex {
        namespace common {
            ...
            struct _LIB_THEKOGANS_MEX_COMMON_DECL ToolBarZoomInEventHandler :
                    public core::ToolBar::Item::CommandEventHandler {
                core::Module &module;

                explicit ToolBarZoomInEventHandler (core::Module &module_) : module (module_) {}
...
#endif // !defined (__thekogans_mex_common_ToolBarZoomInEventHandler_h)
