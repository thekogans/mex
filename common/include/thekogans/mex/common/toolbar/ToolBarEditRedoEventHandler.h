...
#if !defined (__thekogans_mex_common_ToolBarEditRedoEventHandler_h)
#define __thekogans_mex_common_ToolBarEditRedoEventHandler_h
...
namespace thekogans {
    namespace mex {
        namespace common {
            ...
            struct ToolBarEditRedoEventHandler : public core::ToolBar::Item::CommandEventHandler {
                core::Module &module;

                explicit ToolBarEditRedoEventHandler (core::Module &module_) : module (module_) {}
                ...
                virtual void OnUpdateUI (UI &ui) {
                    ui.SetEnabled (core::GetCommandDispatcher ().CanRedo ());
                }
            };
...
#endif // !defined (__thekogans_mex_common_ToolBarEditRedoEventHandler_h)
