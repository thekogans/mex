...
#if !defined (__thekogans_mex_common_FiltersSHPEventHandler_h)
#define __thekogans_mex_common_FiltersSHPEventHandler_h
...
namespace thekogans {
    namespace mex {
        namespace common {
            ...
            struct _LIB_THEKOGANS_MEX_COMMON_DECL FiltersSHPEventHandler :
                    public core::Filters::Item::EventHandler {
                core::Module &module;

                explicit FiltersSHPEventHandler (core::Module &module_) :
                    module (module_) {}
...
#endif // !defined (__thekogans_mex_common_FiltersSHPEventHandler_h)
