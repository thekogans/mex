...
#if !defined (__thekogans_mex_common_FiltersLFTEventHandler_h)
#define __thekogans_mex_common_FiltersLFTEventHandler_h
...
namespace thekogans {
    namespace mex {
        namespace common {
            ...
            struct _LIB_THEKOGANS_MEX_COMMON_DECL FiltersLFTEventHandler :
                    public core::Filters::Item::EventHandler {
                core::Module &module;

                explicit FiltersLFTEventHandler (core::Module &module_) :
                    module (module_) {}
...
#endif // !defined (__thekogans_mex_common_FiltersLFTEventHandler_h)
