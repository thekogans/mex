...
#if !defined (__thekogans_mex_common_Filters3DSEventHandler_h)
#define __thekogans_mex_common_Filters3DSEventHandler_h
...
namespace thekogans {
    namespace mex {
        namespace common {
            ...
            struct _LIB_THEKOGANS_MEX_COMMON_DECL Filters3DSEventHandler :
                    public core::Filters::Item::EventHandler {
                core::Module &module;

                explicit Filters3DSEventHandler (core::Module &module_) :
                    module (module_) {}
...
#endif // !defined (__thekogans_mex_common_Filters3DSEventHandler_h)
