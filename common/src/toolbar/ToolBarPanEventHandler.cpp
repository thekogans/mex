...
namespace thekogans {
    namespace mex {
        namespace common {
            ...
            namespace {
                const char *CONSOLE_1 = "Pan: Select point to pan from\n";
                const char *CONSOLE_2 = "Pan: Select point to pan to\n";
            }

            void ToolBarPanEventHandler::Tool::SetFocus () {
            ...
            void ToolBarPanEventHandler::Tool::LButtonDown (
                ...
                if (state == 0) {
                    ...
                    to = pt;
                    core::DrawArrow2 (view, from, to);
                }
            }

            void ToolBarPanEventHandler::Tool::LButtonUp (
                    const _3ds::opengl::View &view,
                    util::ui32 flags,
                    const blas::Point2 &pt) {
                if (state == 1) {
            ...
            void ToolBarPanEventHandler::Tool::RButtonDown (
                    const _3ds::opengl::View &view,
                    util::ui32 flags,
                    const blas::Point2 &pt) {
                if (state == 0) {
            ...
            void ToolBarPanEventHandler::Tool::RButtonUp (
                    const _3ds::opengl::View &view,
                    util::ui32 flags,
                    const blas::Point2 &pt) {
                if (IsOddState ()) {
            ...
            void ToolBarPanEventHandler::Tool::MouseMove (
                    const _3ds::opengl::View &view,
                    util::ui32,
                    const blas::Point2 &pt) {
                if (state == 2) {
            ...
            void ToolBarPanEventHandler::Tool::UpdateUI (
                    const _3ds::opengl::View &view) {
                if (state == 2) {
                    core::DrawArrow2 (view, from, to);
                }
