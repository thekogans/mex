...
#if !defined (__thekogans_mex_SpeedBarFrame_h)
#define __thekogans_mex_SpeedBarFrame_h
...
namespace thekogans {
    namespace mex {
        ...
        struct SpeedBarFrame : public QDockWidget {
            Q_OBJECT
        ...
        public:
            SpeedBarFrame (QWidget *parent = 0);
        };

    } // namespace mex
} // namespace thekogans

#endif // !defined (__thekogans_mex_SpeedBarFrame_h)
