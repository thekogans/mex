...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            THEKOGANS_MEX_CORE_IMPLEMENT_COMMON_FILTERS_ITEM_EVENT_HANDLER (FiltersSHPEventHandler, Shaper)
            THEKOGANS_MEX_CORE_IMPLEMENT_COMMON_FILTERS_ITEM_EVENT_HANDLER (FiltersPRJEventHandler, Shaper)
