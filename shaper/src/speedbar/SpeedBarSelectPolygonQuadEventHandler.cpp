...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            namespace {
                const char *IDS_SELECTPOLYGONQUAD_0 = "Select first corner of quad: use CTRL key to deselect\n";
                const char *IDS_SELECTPOLYGONQUAD_1 = "Select opposite corner of quad\n";
            }

            class SpeedBarSelectPolygonQuadEventHandler : public core::SpeedBar::Item::ToolEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarSelectPolygonQuadEventHandler)

            private:
                // Select a set of polygons which fall within a defined quadrillateral.
                class Tool : public core::Tool {
                    THEKOGANS_MEX_CORE_DECLARE_TOOL (SpeedBarSelectPolygonQuadEventHandlerTool)
                ...
                public:
                    ...
                    virtual void SetFocus () {
                        ...
                        core::UI::Instance ().consoleWindow->Print (IDS_SELECTPOLYGONQUAD_0);
                    }
                    ...
                    virtual void LButtonUp (const _3ds::opengl::View &view, util::ui32 flags, const blas::Point2 &pt) {
                        if (state == 1) {
                            ...
                            core::UI::Instance ().consoleWindow->Print (IDS_SELECTPOLYGONQUAD_1);
                        }
                        else if (state == 3) {
            ...
            public:
                explicit SpeedBarSelectPolygonQuadEventHandler (core::Module &module) :
                    ToolEventHandler (module, tool), tool (module) {}
            };

            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarSelectPolygonQuadEventHandler, Shaper)
