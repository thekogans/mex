...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            struct SpeedBarDisplayFreezeInvertEventHandler : public core::SpeedBar::Item::CommandEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarDisplayFreezeInvertEventHandler)

            private:
                core::Module &module;

            public:
                explicit SpeedBarDisplayFreezeInvertEventHandler (core::Module &module_) :
                    module (module_) {}
            ...
            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarDisplayFreezeInvertEventHandler, Shaper)
