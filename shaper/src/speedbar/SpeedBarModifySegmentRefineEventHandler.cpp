...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            namespace {
                const char *IDS_MODIFYSEGMENTREFINE_0 = "Select segment to refine\n";
            }

            class SpeedBarModifySegmentRefineEventHandler : public core::SpeedBar::Item::ToolEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarModifySegmentRefineEventHandler)

            private:
                class Tool : public core::Tool {
                    THEKOGANS_MEX_CORE_DECLARE_TOOL (SpeedBarModifySegmentRefineEventHandlerTool)
                ...
                public:
                    ...
                    virtual void SetFocus () {
                        ...
                        core::UI::Instance ().consoleWindow->Print (IDS_MODIFYSEGMENTREFINE_0);
                    }
                    ...
                    virtual void LButtonDown (const _3ds::opengl::View &view, util::ui32 flags, const blas::Point2 &pt) {
                        if (state == 0) {
                            ...
                            if (pickInfo.FindFirst ()) {
                                ...
                                if (selected) {
                                    ErasePolygon (*bezierPolygon, false);
                                }
                                else {
            ...
            public:
                explicit SpeedBarModifySegmentRefineEventHandler (core::Module &module) :
                    ToolEventHandler (module, tool), tool (module) {}
            };

            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarModifySegmentRefineEventHandler, Shaper)
