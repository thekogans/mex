...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            namespace {
                const char *IDS_MODIFYSEGMENTLINEAR_0 = "Select segment to make linear\n";
            }

            class SpeedBarModifySegmentLinearEventHandler : public core::SpeedBar::Item::ToolEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarModifySegmentLinearEventHandler)

            private:
                class Tool : public core::Tool {
                    THEKOGANS_MEX_CORE_DECLARE_TOOL (SpeedBarModifySegmentLinearEventHandlerTool)
                ...
                public:
                    ...
                    virtual void SetFocus () {
                        ...
                        core::UI::Instance ()->consoleWindow->Print (IDS_MODIFYSEGMENTLINEAR_0);
                    }
                        ...
                        if (state == 0) {
                            ...
                            if (pickInfo.FindFirst ()) {
                                ...
                                if (!bezierPolygon->vertices[vertexIndex1].yellow.IsZero () ||
                                    !bezierPolygon->vertices[vertexIndex2].red.IsZero ()) {
                                    BeginTransaction ();
                                    EraseSegment (*bezierPolygon, vertexIndex1, vertexIndex2, false);
                                    ExecuteAndAddCommand (
                                        command::Command::SharedPtr (
                                            new _3ds::io::command::BezierPolygon2SegmentLinearCommand (
            ...
            public:
                explicit SpeedBarModifySegmentLinearEventHandler (core::Module &module) :
                    ToolEventHandler (module, tool), tool (module) {}
            };

            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarModifySegmentLinearEventHandler, Shaper)
