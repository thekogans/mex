...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            struct SpeedBarSelectAllEventHandler : public core::SpeedBar::Item::CommandEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarSelectAllEventHandler)

            private:
                core::Module &module;

            public:
                explicit SpeedBarSelectAllEventHandler (core::Module &module_) :
                    module (module_) {}

                virtual void OnSetFocus () {
                    core::GetCommandDispatcher ().BeginTransaction (
                        command::TransactionFactory::UniquePtr (
                            new core::command::TransactionFactory ("SpeedBarSelectAllEventHandler")));
            ...
            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarSelectAllEventHandler, Shaper)
