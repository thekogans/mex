...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            struct SpeedBarDisplayFreezeAllEventHandler : public core::SpeedBar::Item::CommandEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarDisplayFreezeAllEventHandler)

            private:
                core::Module &module;

            public:
                explicit SpeedBarDisplayFreezeAllEventHandler (core::Module &module_) :
                    module (module_) {}

                virtual void OnSetFocus () {
                    core::GetCommandDispatcher ().BeginTransaction (
                        command::TransactionFactory::SharedPtr (
                            new core::command::TransactionFactory ("SpeedBarDisplayFreezeAllEventHandler")));
            ...
            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarDisplayFreezeAllEventHandler, Shaper)
