...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            namespace {
                const char *IDS_DISPLAYHIDEPOLYGONSINGLE_0 = "Select polygon(s) to hide\n";
            }

            class SpeedBarDisplayHidePolygonSingleEventHandler : public core::SpeedBar::Item::ToolEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarDisplayHidePolygonSingleEventHandler)

            private:
                // Assign a polygon or a Shapeion set of polygons as shape.
                class Tool : public core::Tool {
                    THEKOGANS_MEX_CORE_DECLARE_TOOL (SpeedBarDisplayHidePolygonSingleEventHandlerTool)
                ...
                public:
                    ...
                    virtual void SetFocus () {
                        ...
                        core::UI::Instance ().consoleWindow->Print (IDS_DISPLAYHIDEPOLYGONSINGLE_0);
                    }
                            ...
                            if (bezierPolygons.empty ()) {
                                ...
                                if (IsSelect ()) {
                                    ...
                                    for (std::size_t i = 0, count = bezierPolygons.size (); i < count; ++i) {
                                        _3ds::io::BezierPolygon2 *bezierPolygon = bezierPolygons[i];
            ...
            public:
                explicit SpeedBarDisplayHidePolygonSingleEventHandler (core::Module &module) :
                    ToolEventHandler (module, tool), tool (module) {}
            };

            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarDisplayHidePolygonSingleEventHandler, Shaper)
