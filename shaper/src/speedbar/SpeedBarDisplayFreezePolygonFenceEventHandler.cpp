...
#include "thekogans/mex/shaper/command/FreezePolygonsInRegionCommand.h"
#include "thekogans/mex/shaper/command/ThawPolygonsInRegionCommand.h"
...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            namespace {
                const char *IDS_DISPLAYFREEZEPOLYGONFENCE_0 = "Select first point of fence: CTRL to thaw, SPACE to close\n";
                const char *IDS_DISPLAYFREEZEPOLYGONFENCE_1 = "Select points of fenced area. Hit SPACE to close\n";
            }

            class SpeedBarDisplayFreezePolygonFenceEventHandler : public core::SpeedBar::Item::ToolEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarDisplayFreezePolygonFenceEventHandler)

            private:
                class Tool : public core::Tool {
                    THEKOGANS_MEX_CORE_DECLARE_TOOL (SpeedBarDisplayFreezePolygonFenceEventHandlerTool)
                ...
                public:
                    ...
                    virtual void SetFocus () {
                        ...
                        core::UI::Instance ().consoleWindow->Print (IDS_DISPLAYFREEZEPOLYGONFENCE_0);
                    }
                    ...
                    virtual void LButtonUp (const _3ds::opengl::View &view, util::ui32 flags, const blas::Point2 &pt) {
                        if (state == 1) {
                            ...
                            core::UI::Instance ().consoleWindow->Print (IDS_DISPLAYFREEZEPOLYGONFENCE_1);
                        }
                        else if (state == 3) {
                            UpdateState (2, flags | ScrollLockOff | CursorVisible);
                        }
            ...
            public:
                explicit SpeedBarDisplayFreezePolygonFenceEventHandler (core::Module &module) :
                    ToolEventHandler (module, tool), tool (module) {}
            };

            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarDisplayFreezePolygonFenceEventHandler, Shaper)
