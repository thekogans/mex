...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            struct SpeedBarDisplayHideAllEventHandler : public core::SpeedBar::Item::CommandEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarDisplayHideAllEventHandler)

            private:
                core::Module &module;

            public:
                explicit SpeedBarDisplayHideAllEventHandler (core::Module &module_) :
                    module (module_) {}
            ...
            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarDisplayHideAllEventHandler, Shaper)
