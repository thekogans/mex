...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            struct SpeedBarSelectInvertEventHandler : public core::SpeedBar::Item::CommandEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarSelectInvertEventHandler)

            private:
                core::Module &module;

            public:
                explicit SpeedBarSelectInvertEventHandler (core::Module &module_) :
                    module (module_) {}

                virtual void OnSetFocus () {
                    core::GetCommandDispatcher ().BeginTransaction (
                        command::TransactionFactory::SharedPtr (
                            new core::command::TransactionFactory ("SpeedBarSelectInvertEventHandler")));
            ...
            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarSelectInvertEventHandler, Shaper)
