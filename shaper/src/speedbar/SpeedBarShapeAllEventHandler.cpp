...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            struct SpeedBarShapeAllEventHandler : public core::SpeedBar::Item::CommandEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarShapeAllEventHandler)

            private:
                core::Module &module;

            public:
                explicit SpeedBarShapeAllEventHandler (core::Module &module_) :
                    module (module_) {}

                virtual void OnSetFocus () {
                    core::GetCommandDispatcher ().BeginTransaction (
                        command::TransactionFactory::SharedPtr (
                            new core::command::TransactionFactory ("SpeedBarShapeAllEventHandler")));
            ...
            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarShapeAllEventHandler, Shaper)
