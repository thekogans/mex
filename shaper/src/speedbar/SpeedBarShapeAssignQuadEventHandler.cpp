...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            namespace {
                const char *IDS_SHAPEASSIGNQUAD_0 = "Select first corner of quad: use CTRL key to unassign\n";
                const char *IDS_SHAPEASSIGNQUAD_1 = "Select opposite corner of quad\n";
            }

            class SpeedBarShapeAssignQuadEventHandler : public core::SpeedBar::Item::ToolEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarShapeAssignQuadEventHandler)

            private:
                // Assign as shape a set of polygons which fall within a defined quadrillateral.
                class Tool : public core::Tool {
                    THEKOGANS_MEX_CORE_DECLARE_TOOL (SpeedBarShapeAssignQuadEventHandlerTool)
                                ...
                                ExecuteAndAddCommand (
                                    command::Command::SharedPtr (
                                        new UnassignPolygonsInRegionCommand (
                                            blas::Region2::UniquePtr (new blas::BoundRegion2 (bound.Normalize ()))))) :
                                ExecuteAndAddCommand (
                                    command::Command::SharedPtr (
            ...
            public:
                explicit SpeedBarShapeAssignQuadEventHandler (core::Module &module) :
                    ToolEventHandler (module, tool), tool (module) {}
            };

            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarShapeAssignQuadEventHandler, Shaper)
