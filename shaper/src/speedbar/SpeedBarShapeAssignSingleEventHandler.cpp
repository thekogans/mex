...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            namespace {
                const char *IDS_SHAPEASSIGNSINGLE_0 = "Select polygon(s) to assign as shape\n";
            }

            class SpeedBarShapeAssignSingleEventHandler : public core::SpeedBar::Item::ToolEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarShapeAssignSingleEventHandler)

            private:
                // Assign a polygon or a Shapeion set of polygons as shape.
                class Tool : public core::Tool {
                    THEKOGANS_MEX_CORE_DECLARE_TOOL (SpeedBarShapeAssignSingleEventHandlerTool)
                ...
                public:
                    ...
                    virtual void SetFocus () {
                        ...
                        core::UI::Instance ().consoleWindow->Print (IDS_SHAPEASSIGNSINGLE_0);
                    }
            ...
            public:
                explicit SpeedBarShapeAssignSingleEventHandler (core::Module &module) :
                    ToolEventHandler (module, tool), tool (module) {}
            };

            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarShapeAssignSingleEventHandler, Shaper)
