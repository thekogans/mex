...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            namespace {
                const char *IDS_DISPLAYFREEZEPOLYGONQUAD_0 = "Select first corner of quad: use CTRL key to thaw\n";
                const char *IDS_DISPLAYFREEZEPOLYGONQUAD_1 = "Select opposite corner of quad\n";
            }

            class SpeedBarDisplayFreezePolygonQuadEventHandler : public core::SpeedBar::Item::ToolEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarDisplayFreezePolygonQuadEventHandler)

            private:
                class Tool : public core::Tool {
                    THEKOGANS_MEX_CORE_DECLARE_TOOL (SpeedBarDisplayFreezePolygonQuadEventHandlerTool)
                ...
                public:
                    ...
                    virtual void SetFocus () {
                        ...
                        core::UI::Instance ().consoleWindow->Print (IDS_DISPLAYFREEZEPOLYGONQUAD_0);
                    }
                    ...
                    virtual void LButtonUp (const _3ds::opengl::View &view, util::ui32 flags, const blas::Point2 &pt) {
                        if (state == 1) {
                            ...
                            core::UI::Instance ().consoleWindow->Print (IDS_DISPLAYFREEZEPOLYGONQUAD_1);
                        }
                        else if (state == 3) {
            ...
            public:
                explicit SpeedBarDisplayFreezePolygonQuadEventHandler (core::Module &module) :
                    ToolEventHandler (module, tool), tool (module) {}
            };

            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarDisplayFreezePolygonQuadEventHandler, Shaper)
