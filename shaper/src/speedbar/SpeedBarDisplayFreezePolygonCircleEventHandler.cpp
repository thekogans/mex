...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            namespace {
                const char *IDS_DISPLAYFREEZEPOLYGONCIRCLE_0 = "Select center of circle: use CTRL key to thaw\n";
                const char *IDS_DISPLAYFREEZEPOLYGONCIRCLE_1 = "Select radius of circle\n";
            }

            class SpeedBarDisplayFreezePolygonCircleEventHandler : public core::SpeedBar::Item::ToolEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarDisplayFreezePolygonCircleEventHandler)

            private:
                class Tool : public core::Tool {
                    THEKOGANS_MEX_CORE_DECLARE_TOOL (SpeedBarDisplayFreezePolygonCircleEventHandlerTool)
            ...
            public:
                explicit SpeedBarDisplayFreezePolygonCircleEventHandler (core::Module &module) :
                    ToolEventHandler (module, tool), tool (module) {}
            };

            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarDisplayFreezePolygonCircleEventHandler, Shaper)
