...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            namespace {
                const char *IDS_CREATECIRCLE_0 = "Place center of circle:\n";
                const char *IDS_CREATECIRCLE_1 = "Set circle radius\n";
                const char *IDS_CREATECIRCLE_2 = "Radius: %s\n";
            }

            class SpeedBarCreateCircleEventHandler : public core::SpeedBar::Item::ToolEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarCreateCircleEventHandler)

            private:
                class Tool : public core::Tool {
                    THEKOGANS_MEX_CORE_DECLARE_TOOL (SpeedBarCreateCircleEventHandlerTool)
                ...
                public:
                    ...
                    virtual void SetFocus () {
                        ...
                        core::UI::Instance ().consoleWindow->Print (IDS_CREATECIRCLE_0);
                    }
                    ...
                    virtual void LButtonUp (const _3ds::opengl::View &view, util::ui32 flags, const blas::Point2 &pt) {
                        if (state == 1) {
                            ...
                            core::UI::Instance ().consoleWindow->Print (IDS_CREATECIRCLE_1);
                        }
                        else if (state == 3) {
                            UpdateState (0, flags | ScrollLockOff | CursorVisible | ViewReleased);
                            if (circle.radius != 0.0f) {
                                core::WaitCursor waitCursor;
                                AddPolygon (_3ds::ext::Circle (circle.center, circle.radius));
                                CommitTransaction ();
                            }
                            else {
                                AbortTransaction ();
            ...
            public:
                explicit SpeedBarCreateCircleEventHandler (core::Module &module) :
                    ToolEventHandler (module, tool), tool (module) {}
            };

            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarCreateCircleEventHandler, Shaper)
