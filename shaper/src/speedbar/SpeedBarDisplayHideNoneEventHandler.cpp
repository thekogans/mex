...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            struct SpeedBarDisplayHideNoneEventHandler : public core::SpeedBar::Item::CommandEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarDisplayHideNoneEventHandler)

            private:
                core::Module &module;

            public:
                explicit SpeedBarDisplayHideNoneEventHandler (core::Module &module_) :
                    module (module_) {}
            ...
            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarDisplayHideNoneEventHandler, Shaper)
