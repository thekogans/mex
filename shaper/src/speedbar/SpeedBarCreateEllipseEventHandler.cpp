...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            namespace {
                const char *IDS_CREATEELLIPSE_0 = "Place one corner of ellipse bounding quadrilateral:\n";
                const char *IDS_CREATEELLIPSE_1 = "Place opposite corner of ellipse bounding quadrilateral:\n";
                const char *IDS_CREATEELLIPSE_21 = "Size: %s\n";
                const char *IDS_CREATEELLIPSE_22 = "[%s %s]\n";
            }

            class SpeedBarCreateEllipseEventHandler : public core::SpeedBar::Item::ToolEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarCreateEllipseEventHandler)

            private:
                // Create an ellipse.
                class Tool : public core::Tool {
                    THEKOGANS_MEX_CORE_DECLARE_TOOL (SpeedBarCreateEllipseEventHandlerTool)
                ...
                public:
                    ...
                    virtual void SetFocus () {
                        ...
                        core::UI::Instance ().consoleWindow->Print (IDS_CREATEELLIPSE_0);
                    }
                    ...
                    virtual void LButtonDown (const _3ds::opengl::View &view, util::ui32 flags, const blas::Point2 &pt) {
                        if (state == 0) {
                            ...
                            bound = pt;
                            square = IsCtrl ();
                            core::DrawEllipse2 (view, blas::Ellipse (bound),
                    ...
                    virtual void LButtonUp (const _3ds::opengl::View &view, util::ui32 flags, const blas::Point2 &pt) {
                        if (state == 1) {
                            ...
                            core::UI::Instance ().consoleWindow->Print (IDS_CREATEELLIPSE_1);
                        }
                        else if (state == 3) {
                            ...
                            if (bound.min != bound.max) {
                                ...
                                AddPolygon (_3ds::ext::Ellipse (bound));
                                CommitTransaction ();
                            }
                            else {
                                AbortTransaction ();
                    ...
                    virtual void UpdateStatus (core::StatusBar::Item::EventHandler::UI &ui) {
                        if (state == 2) {
                            if (square) {
                                ui.SetText (IDS_CREATEELLIPSE_21,
                                    _3ds::ext::Units (core::GetIOProject ().units).Format (
                                        fabsf (bound.max.x - bound.min.x)).c_str ());
                            }
                            else {
                                ui.SetText (IDS_CREATEELLIPSE_22,
                                    _3ds::ext::Units (core::GetIOProject ().units).Format (
            ...
            public:
                explicit SpeedBarCreateEllipseEventHandler (core::Module &module) :
                    ToolEventHandler (module, tool), tool (module) {}
            };

            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarCreateEllipseEventHandler, Shaper)
