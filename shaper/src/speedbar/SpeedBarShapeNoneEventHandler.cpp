...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            struct SpeedBarShapeNoneEventHandler : public core::SpeedBar::Item::CommandEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarShapeNoneEventHandler)

            private:
                core::Module &module;

            public:
                explicit SpeedBarShapeNoneEventHandler (core::Module &module_) :
                    module (module_) {}

                virtual void OnSetFocus () {
                    core::GetCommandDispatcher ().BeginTransaction (
                        command::TransactionFactory::UniquePtr (
                            new core::command::TransactionFactory ("SpeedBarShapeNoneEventHandler")));
            ...
            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarShapeNoneEventHandler, Shaper)
