...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            namespace {
                const char *IDS_CREATECOPY_0 = "Select polygon to copy, [Tab] = change cursor\n";
                const char *IDS_CREATECOPY_2 = "Offsets: x: %s, y: %s";
            }

            class SpeedBarCreateCopyEventHandler : public core::SpeedBar::Item::ToolEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarCreateCopyEventHandler)

            private:
                // Move polygon or a selection set of polygons.
                class Tool : public core::Tool {
                    THEKOGANS_MEX_CORE_DECLARE_TOOL (SpeedBarCreateCopyEventHandlerTool)
            ...
            public:
                explicit SpeedBarCreateCopyEventHandler (core::Module &module) :
                    ToolEventHandler (module, tool), tool (module) {}
            };

            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarCreateCopyEventHandler, Shaper)
