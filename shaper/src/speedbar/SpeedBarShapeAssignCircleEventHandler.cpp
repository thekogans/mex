...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            namespace {
                const char *IDS_SHAPEASSIGNCIRCLE_0 = "Select center of circle: use CTRL key to unassign\n";
                const char *IDS_SHAPEASSIGNCIRCLE_1 = "Select radius of circle\n";
            }

            class SpeedBarShapeAssignCircleEventHandler : public core::SpeedBar::Item::ToolEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarShapeAssignCircleEventHandler)

            private:
                class Tool : public core::Tool {
                    THEKOGANS_MEX_CORE_DECLARE_TOOL (SpeedBarShapeAssignCircleEventHandlerTool)
                ...
                public:
                    ...
                    virtual void SetFocus () {
                        ...
                        core::UI::Instance ()->consoleWindow->Print (IDS_SHAPEASSIGNCIRCLE_0);
                    }
                    ...
                    virtual void LButtonUp (const _3ds::opengl::View &view, util::ui32 flags, const blas::Point2 &pt) {
                        if (state == 1) {
                            ...
                            core::UI::Instance ()->consoleWindow->Print (IDS_SHAPEASSIGNCIRCLE_1);
                        }
                        else if (state == 3) {
            ...
            public:
                explicit SpeedBarShapeAssignCircleEventHandler (core::Module &module) :
                    ToolEventHandler (module, tool), tool (module) {}
            };

            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarShapeAssignCircleEventHandler, Shaper)
