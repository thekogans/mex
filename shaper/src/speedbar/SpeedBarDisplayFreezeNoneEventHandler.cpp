...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            struct SpeedBarDisplayFreezeNoneEventHandler : public core::SpeedBar::Item::CommandEventHandler {
                THEKOGANS_MEX_CORE_DECLARE_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarDisplayFreezeNoneEventHandler)

            private:
                core::Module &module;

            public:
                explicit SpeedBarDisplayFreezeNoneEventHandler (core::Module &module_) :
                    module (module_) {}

                virtual void OnSetFocus () {
                    core::GetCommandDispatcher ().BeginTransaction (
                        command::TransactionFactory::SharedPtr (
                            new core::command::TransactionFactory ("SpeedBarDisplayFreezeNoneEventHandler")));
            ...
            THEKOGANS_MEX_CORE_IMPLEMENT_SPEEDBAR_ITEM_EVENT_HANDLER (SpeedBarDisplayFreezeNoneEventHandler, Shaper)
