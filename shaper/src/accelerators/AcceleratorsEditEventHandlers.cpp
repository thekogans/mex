...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            THEKOGANS_MEX_CORE_IMPLEMENT_COMMON_ACCELERATORS_ITEM_EVENT_HANDLER (AcceleratorsEditUndoEventHandler, Shaper)
            THEKOGANS_MEX_CORE_IMPLEMENT_COMMON_ACCELERATORS_ITEM_EVENT_HANDLER (AcceleratorsEditRedoEventHandler, Shaper)
