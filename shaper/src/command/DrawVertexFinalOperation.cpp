...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            THEKOGANS_MEX_COMMAND_IMPLEMENT_FINAL_OPERATION (DrawVertexFinalOperation)

            bool DrawVertexFinalOperation::Execute () {
                    ...
                    if (openglView.get () != 0) {
                        ...
                        _3ds::opengl::BezierPolygon2 (bezierPolygon, flags, core::GetIOProject ().shaper.steps,
                            _3ds::io::Lofter::ModelParams::High, _3ds::io::BezierPolygon2::Vertex::GetSelectionSet (
                                core::GetIOProject ().shaper.selectMask)).DrawVertex (*openglView, vertexIndex);
                    }
                }
                return true;
            }
