...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            THEKOGANS_MEX_COMMAND_IMPLEMENT_COMMAND (ErasePolygonsCommand)

            bool ErasePolygonsCommand::Undo () {
            ...
            bool ErasePolygonsCommand::Redo () {
                if (view.IsShape () && view.IsEnabled ()) {
                    _3ds::opengl::View::UniquePtr openglView =
                        core::GetOpenGLProject ().shaper.GetView (view);
                    assert (openglView.get () != 0);
                    if (openglView.get () != 0) {
                        ...
                        _3ds::opengl::SetupView setupView (*openglView);
                        for (std::size_t i = 0, count = bezierPolygons.size (); i < count; ++i) {
                            _3ds::opengl::BezierPolygon2 (*bezierPolygons[i], _3ds::opengl::BezierPolygon2::ShowVertices,
