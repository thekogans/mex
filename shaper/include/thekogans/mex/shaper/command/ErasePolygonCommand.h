...
#if !defined (__thekogans_mex_shaper_command_ErasePolygonCommand_h)
#define __thekogans_mex_shaper_command_ErasePolygonCommand_h
...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            struct _LIB_THEKOGANS_MEX_SHAPER_DECL ErasePolygonCommand :
                    public thekogans::mex::command::Command {
                THEKOGANS_MEX_COMMAND_DECLARE_COMMAND (ErasePolygonCommand)

                const _3ds::io::View &view;
                const _3ds::io::BezierPolygon2 &bezierPolygon;

                explicit ErasePolygonCommand (
...
#endif // !defined (__thekogans_mex_shaper_command_ErasePolygonCommand_h)
