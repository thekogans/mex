...
#if !defined (__thekogans_mex_shaper_command_EraseSegmentCommand_h)
#define __thekogans_mex_shaper_command_EraseSegmentCommand_h
...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            struct _LIB_THEKOGANS_MEX_SHAPER_DECL EraseSegmentCommand :
                    public thekogans::mex::command::Command {
                THEKOGANS_MEX_COMMAND_DECLARE_COMMAND (EraseSegmentCommand)
...
#endif // !defined (__thekogans_mex_shaper_command_EraseSegmentCommand_h)
