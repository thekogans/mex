...
#if !defined (__thekogans_mex_shaper_command_ErasePolygonsCommand_h)
#define __thekogans_mex_shaper_command_ErasePolygonsCommand_h
...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            struct _LIB_THEKOGANS_MEX_SHAPER_DECL ErasePolygonsCommand :
                    public thekogans::mex::command::Command {
                THEKOGANS_MEX_COMMAND_DECLARE_COMMAND (ErasePolygonsCommand)

                const _3ds::io::View &view;
                const std::vector<_3ds::io::BezierPolygon2 *> bezierPolygons;

                explicit ErasePolygonsCommand (
...
#endif // !defined (__thekogans_mex_shaper_command_ErasePolygonsCommand_h)
