...
#if !defined (__thekogans_mex_shaper_command_DrawVertexFinalOperation_h)
#define __thekogans_mex_shaper_command_DrawVertexFinalOperation_h
...
namespace thekogans {
    namespace mex {
        namespace shaper {
            ...
            struct _LIB_THEKOGANS_MEX_SHAPER_DECL DrawVertexFinalOperation :
                    public thekogans::mex::command::FinalOperation {
                THEKOGANS_MEX_COMMAND_DECLARE_FINAL_OPERATION (DrawVertexFinalOperation)

                const _3ds::io::View &view;
                const _3ds::io::BezierPolygon2 &bezierPolygon;
                std::size_t vertexIndex;

                explicit DrawVertexFinalOperation (
...
#endif // !defined (__thekogans_mex_shaper_command_DrawVertexFinalOperation_h)
