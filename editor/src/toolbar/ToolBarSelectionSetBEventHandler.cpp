        ...
        namespace editor {
            ...
            struct ToolBarSelectionSetBEventHandler : public core::ToolBar::Item::ButtonEventHandler {
                ...
                virtual void OnClickLeft () {
                    core::GetIOProject ().editor.selectMask = _3ds::io::Mesh::SelectionSetB;
                    core::GetIOProject ().editor.unselectMask = ~_3ds::io::Mesh::SelectionSetB;
                    core::command::DrawViewLayoutFinalOperation (module).Execute ();
                    core::command::FlipFramebufferFinalOperation ().Execute ();
                }
                virtual bool IsChecked () const {
                    return core::GetIOProject ().editor.selectMask == _3ds::io::Mesh::SelectionSetB;
                }
            };

            THEKOGANS_MEX_CORE_IMPLEMENT_TOOLBAR_ITEM_EVENT_HANDLER (ToolBarSelectionSetBEventHandler, Editor)
