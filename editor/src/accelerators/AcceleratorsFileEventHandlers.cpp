...
namespace thekogans {
    namespace mex {
        namespace editor {
            ...
            //THEKOGANS_MEX_CORE_IMPLEMENT_COMMON_ACCELERATORS_ITEM_EVENT_HANDLER (AcceleratorsFileNewEventHandler, Editor)
            THEKOGANS_MEX_CORE_IMPLEMENT_COMMON_ACCELERATORS_ITEM_EVENT_HANDLER (AcceleratorsFileOpenEventHandler, Editor)
            //THEKOGANS_MEX_CORE_IMPLEMENT_COMMON_ACCELERATORS_ITEM_EVENT_HANDLER (AcceleratorsFileSaveEventHandler, Editor)
