...
namespace thekogans {
    namespace mex {
        namespace editor {
            ...
            THEKOGANS_MEX_CORE_IMPLEMENT_COMMON_FILTERS_ITEM_EVENT_HANDLER (Filters3DSEventHandler, Editor)
            THEKOGANS_MEX_CORE_IMPLEMENT_COMMON_FILTERS_ITEM_EVENT_HANDLER (FiltersPRJEventHandler, Editor)
