...
#if !defined (__thekogans_mex_command_Version_h)
#define __thekogans_mex_command_Version_h
...
namespace thekogans {
    namespace mex {
        namespace command {
            ...
            /// \brief
            /// Return the compiled command version.
            /// \return Compiled command version.
...
#endif // !defined (__thekogans_mex_command_Version_h)
