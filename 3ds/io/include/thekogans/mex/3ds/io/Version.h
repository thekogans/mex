...
#if !defined (__thekogans_mex_3ds_io_Version_h)
#define __thekogans_mex_3ds_io_Version_h
    ...
    namespace mex {
        namespace _3ds {
            namespace io {
                ...
                /// \brief
                /// Return the compiled 3ds_io version.
                /// \return Compiled 3ds_io version.
                _LIB_THEKOGANS_MEX_3DS_IO_DECL const util::Version &
                    _LIB_THEKOGANS_MEX_3DS_IO_API GetVersion ();
...
#endif // !defined (__thekogans_mex_3ds_io_Version_h)
