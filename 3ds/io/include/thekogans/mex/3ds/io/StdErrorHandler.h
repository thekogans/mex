...
#if !defined (__thekogans_mex_3ds_io_StdErrorHandler_h)
#define __thekogans_mex_3ds_io_StdErrorHandler_h
    ...
    namespace mex {
        namespace _3ds {
            namespace io {
                ...
                struct _LIB_THEKOGANS_MEX_3DS_IO_DECL StdErrorHandler : public ErrorHandler {
...
#endif // !defined (__thekogans_mex_3ds_io_StdErrorHandler_h)
