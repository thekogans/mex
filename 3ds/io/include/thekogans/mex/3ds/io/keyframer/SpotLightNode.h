...
#if !defined (__thekogans_mex_3ds_io_keyframer_SpotLightNode_h)
#define __thekogans_mex_3ds_io_keyframer_SpotLightNode_h
        ...
        namespace _3ds {
            namespace io {
                ...
                struct _LIB_THEKOGANS_MEX_3DS_IO_DECL SpotLightNode : public Node {
                    ...
                    f32Track hotSpotTrack;
                    f32Track fallOffTrack;
                    f32Track rollTrack;
                    ...
                    virtual bool IsKeyFrame (util::ui32 frame) const {
                        return
                            ...
                            colorTrack.IsKeyFrame (frame) ||
                            hotSpotTrack.IsKeyFrame (frame) ||
                            fallOffTrack.IsKeyFrame (frame) ||
...
#endif // !defined (__thekogans_mex_3ds_io_keyframer_SpotLightNode_h)
