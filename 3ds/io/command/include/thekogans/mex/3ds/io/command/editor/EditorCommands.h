...
#if !defined (__thekogans_mex_3ds_io_command_editor_EditorCommands_h)
#define __thekogans_mex_3ds_io_command_editor_EditorCommands_h
        ...
        namespace _3ds {
            namespace io {
                namespace command {
                    ...
                    struct _LIB_THEKOGANS_MEX_3DS_IO_COMMAND_DECL EditorValidateAfterOpenCommand :
                            public thekogans::mex::command::CompoundCommand {
                        THEKOGANS_MEX_COMMAND_DECLARE_COMMAND (EditorValidateAfterOpenCommand)

                        io::Editor &editor;

                        explicit EditorValidateAfterOpenCommand (io::Editor &editor_) :
                            editor (editor_) {}

                        virtual bool Execute ();
                    };

                    struct _LIB_THEKOGANS_MEX_3DS_IO_COMMAND_DECL EditorValidateBeforeSaveCommand :
                            public thekogans::mex::command::CompoundCommand {
                        THEKOGANS_MEX_COMMAND_DECLARE_COMMAND (EditorValidateBeforeSaveCommand)

                        io::Editor &editor;

                        EditorValidateBeforeSaveCommand (io::Editor &editor_) :
                            editor (editor_) {}
...
#endif // !defined (__thekogans_mex_3ds_io_command_editor_EditorCommands_h)
