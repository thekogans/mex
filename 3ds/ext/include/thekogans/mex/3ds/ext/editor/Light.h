...
#if !defined (__thekogans_mex_3ds_ext_editor_Light_h)
#define __thekogans_mex_3ds_ext_editor_Light_h
    ...
    namespace mex {
        namespace _3ds {
            namespace ext {
                ...
                struct _LIB_THEKOGANS_MEX_3DS_EXT_DECL Light {
                    ...
                    explicit Light (const io::Light &light_) : light (light_) {}
...
#endif // !defined (__thekogans_mex_3ds_ext_editor_Light_h)
