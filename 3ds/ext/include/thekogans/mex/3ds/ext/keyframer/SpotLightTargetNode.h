...
#if !defined (__thekogans_mex_3ds_ext_keyframer_SpotLightTargetNode_h)
#define __thekogans_mex_3ds_ext_keyframer_SpotLightTargetNode_h
    ...
    namespace mex {
        namespace _3ds {
            namespace ext {
                ...
                struct _LIB_THEKOGANS_MEX_3DS_EXT_DECL SpotLightTargetNode : public Node {
                    typedef std::unique_ptr<SpotLightTargetNode> UniquePtr;

                    THEKOGANS_UTIL_DECLARE_HEAP (SpotLightTargetNode)
...
#endif // !defined (__thekogans_mex_3ds_ext_keyframer_SpotLightTargetNode_h)
