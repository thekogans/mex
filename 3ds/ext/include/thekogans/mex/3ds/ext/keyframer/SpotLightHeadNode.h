...
#if !defined (__thekogans_mex_3ds_ext_keyframer_SpotLightHeadNode_h)
#define __thekogans_mex_3ds_ext_keyframer_SpotLightHeadNode_h
        ...
        namespace _3ds {
            namespace ext {
                ...
                struct  _LIB_THEKOGANS_MEX_3DS_EXT_DECL SpotLightHeadNode : public Node {
                    ...
                    const f32Track hotSpotTrack;
                    const f32Track fallOffTrack;
                    ...
                    SpotLightHeadNode (const io::Light &light_, const io::SpotLightNode &spotLightNode_,
...
#endif // !defined (__thekogans_mex_3ds_ext_keyframer_SpotLightHeadNode_h)
