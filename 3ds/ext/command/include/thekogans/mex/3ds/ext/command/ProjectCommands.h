...
#if !defined (__thekogans_mex_3ds_ext_command_ProjectCommands_h)
#define __thekogans_mex_3ds_ext_command_ProjectCommands_h
        ...
        namespace _3ds {
            namespace ext {
                namespace command {
                    ...
                    struct _LIB_THEKOGANS_MEX_3DS_EXT_COMMAND_DECL ProjectValidateAfterOpenCommand :
                            public thekogans::mex::command::CompoundCommand {
                        THEKOGANS_MEX_COMMAND_DECLARE_COMMAND (ProjectValidateAfterOpenCommand)

                        ext::Project &project;

                        ProjectValidateAfterOpenCommand (ext::Project &project_) :
                            project (project_) {}
...
#endif // !defined (__thekogans_mex_3ds_ext_command_ProjectCommands_h)
