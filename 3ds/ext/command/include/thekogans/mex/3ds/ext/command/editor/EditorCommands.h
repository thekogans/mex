...
#if !defined (__thekogans_mex_3ds_ext_command_editor_EditorCommands_h)
#define __thekogans_mex_3ds_ext_command_editor_EditorCommands_h
        ...
        namespace _3ds {
            namespace ext {
                namespace command {
                    ...
                    struct _LIB_THEKOGANS_MEX_3DS_EXT_COMMAND_DECL EditorValidateAfterOpenCommand :
                            public thekogans::mex::command::CompoundCommand {
                        THEKOGANS_MEX_COMMAND_DECLARE_COMMAND (EditorValidateAfterOpenCommand)

                        ext::Editor &editor;
                        ext::Editor newEditor;

                        explicit EditorValidateAfterOpenCommand (ext::Editor &editor_) :
                            editor (editor_),
                            newEditor (editor.ioEditor ()) {}
...
#endif // !defined (__thekogans_mex_3ds_ext_command_editor_EditorCommands_h)
