...
#if !defined (__thekogans_mex_3ds_ext_command_Version_h)
#define __thekogans_mex_3ds_ext_command_Version_h
        ...
        namespace _3ds {
            namespace ext {
                namespace command {
                    ...
                    /// \brief
                    /// Return the compiled 3ds_ext_command version.
                    /// \return Compiled 3ds_ext_command version.
                    _LIB_THEKOGANS_MEX_3DS_EXT_COMMAND_DECL const util::Version &
                        _LIB_THEKOGANS_MEX_3DS_EXT_COMMAND_API GetVersion ();
...
#endif // !defined (__thekogans_mex_3ds_ext_command_Version_h)
