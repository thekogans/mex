...
#include "thekogans/mex/3ds/ext/command/Version.h"
                ...
                namespace command {
                    ...
                    _LIB_THEKOGANS_MEX_3DS_EXT_COMMAND_API GetVersion () {
                        static const util::Version version (
                            THEKOGANS_MEX_3DS_EXT_COMMAND_MAJOR_VERSION,
                            THEKOGANS_MEX_3DS_EXT_COMMAND_MINOR_VERSION,
                            THEKOGANS_MEX_3DS_EXT_COMMAND_PATCH_VERSION);
                        return version;
                    }
