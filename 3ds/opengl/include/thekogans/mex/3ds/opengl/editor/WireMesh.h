...
#if !defined (__thekogans_mex_3ds_opengl_editor_WireMesh_h)
#define __thekogans_mex_3ds_opengl_editor_WireMesh_h
        ...
        namespace _3ds {
            namespace opengl {
                ...
                struct _LIB_THEKOGANS_MEX_3DS_OPENGL_DECL WireMesh : public Mesh {
                    ...
                    WireMesh (const io::Mesh &mesh, const io::Project &project);
                ...
                private:
                    WireMesh (const WireMesh &);
                    WireMesh &operator = (const WireMesh &);

                    void DrawVertices (
                        const View &view,
                        const thekogans::mex::opengl::ui8Color &vertexColor,
                        const thekogans::mex::opengl::ui8Color &selectedVertexColor) const;
                    void DrawEdges (
                        const View &view,
                        const thekogans::mex::opengl::ui8Color &edgeColor,
                        const thekogans::mex::opengl::ui8Color &selectedEdgeColor) const;
                    void DrawFaces (
                        const View &view,
                        const thekogans::mex::opengl::ui8Color &faceColor,
                        const thekogans::mex::opengl::ui8Color &selectedFaceColor) const;
                };
...
#endif // !defined (__thekogans_mex_3ds_opengl_editor_WireMesh_h)
