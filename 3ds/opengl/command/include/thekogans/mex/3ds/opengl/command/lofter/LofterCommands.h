...
#if !defined (__thekogans_mex_3ds_opengl_command_lofter_LofterCommands_h)
#define __thekogans_mex_3ds_opengl_command_lofter_LofterCommands_h
        ...
        namespace _3ds {
            namespace opengl {
                namespace command {
                    ...
                    struct _LIB_THEKOGANS_MEX_3DS_OPENGL_COMMAND_DECL LofterValidateAfterOpenCommand :
                            public thekogans::mex::command::CompoundCommand {
                        THEKOGANS_MEX_COMMAND_DECLARE_COMMAND (LofterValidateAfterOpenCommand)

                        opengl::Lofter &lofter;
                        opengl::Lofter newLofter;

                        explicit LofterValidateAfterOpenCommand (opengl::Lofter &lofter_) :
                            lofter (lofter_), newLofter (lofter.extLofter ()) {}
...
#endif // !defined (__thekogans_mex_3ds_opengl_command_lofter_LofterCommands_h)
