...
#if !defined (__thekogans_mex_3ds_opengl_command_keyframer_KeyframerCommands_h)
#define __thekogans_mex_3ds_opengl_command_keyframer_KeyframerCommands_h
        ...
        namespace _3ds {
            namespace opengl {
                namespace command {
                    ...
                    struct _LIB_THEKOGANS_MEX_3DS_OPENGL_COMMAND_DECL KeyframerValidateAfterOpenCommand :
                            public thekogans::mex::command::CompoundCommand {
                        THEKOGANS_MEX_COMMAND_DECLARE_COMMAND (KeyframerValidateAfterOpenCommand)

                        opengl::Keyframer &keyframer;
                        opengl::Keyframer newKeyframer;

                        explicit KeyframerValidateAfterOpenCommand (opengl::Keyframer &keyframer_) :
                            keyframer (keyframer_), newKeyframer (keyframer.extKeyframer ()) {
...
#endif // !defined (__thekogans_mex_3ds_opengl_command_keyframer_KeyframerCommands_h)
