...
#include "thekogans/mex/3ds/opengl/command/Version.h"
                ...
                namespace command {
                    ...
                    _LIB_THEKOGANS_MEX_3DS_OPENGL_COMMAND_API GetVersion () {
                        static const util::Version version (
                            THEKOGANS_MEX_3DS_OPENGL_COMMAND_MAJOR_VERSION,
                            THEKOGANS_MEX_3DS_OPENGL_COMMAND_MINOR_VERSION,
                            THEKOGANS_MEX_3DS_OPENGL_COMMAND_PATCH_VERSION);
                        return version;
                    }
