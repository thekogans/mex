...
#include "thekogans/mex/3ds/opengl/Version.h"
            ...
            namespace opengl {
                ...
                _LIB_THEKOGANS_MEX_3DS_OPENGL_API GetVersion () {
                    static const util::Version version (
                        THEKOGANS_MEX_3DS_OPENGL_MAJOR_VERSION,
                        THEKOGANS_MEX_3DS_OPENGL_MINOR_VERSION,
                        THEKOGANS_MEX_3DS_OPENGL_PATCH_VERSION);
                    return version;
                }
