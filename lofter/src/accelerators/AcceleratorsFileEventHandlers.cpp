...
namespace thekogans {
    namespace mex {
        namespace lofter {
            ...
            //THEKOGANS_MEX_CORE_IMPLEMENT_COMMON_ACCELERATORS_ITEM_EVENT_HANDLER (AcceleratorsFileNewEventHandler, Lofter)
            THEKOGANS_MEX_CORE_IMPLEMENT_COMMON_ACCELERATORS_ITEM_EVENT_HANDLER (AcceleratorsFileOpenEventHandler, Lofter)
            //THEKOGANS_MEX_CORE_IMPLEMENT_COMMON_ACCELERATORS_ITEM_EVENT_HANDLER (AcceleratorsFileSaveEventHandler, Lofter)
