...
#if !defined (__thekogans_mex_core_XercesUtils_h)
#define __thekogans_mex_core_XercesUtils_h
...
namespace thekogans {
    namespace util {
        ...
        struct _LIB_THEKOGANS_MEX_CORE_DECL XercesErrorHandler :
...
#endif // !defined (__thekogans_mex_core_XercesUtils_h)
