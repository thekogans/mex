...
#if !defined (__thekogans_mex_core_command_SetViewLayoutFinalOperation_h)
#define __thekogans_mex_core_command_SetViewLayoutFinalOperation_h
    ...
    namespace mex {
        namespace core {
            namespace command {
                ...
                struct _LIB_THEKOGANS_MEX_CORE_DECL SetViewLayoutFinalOperation :
                        public thekogans::mex::command::FinalOperation {
                    THEKOGANS_MEX_COMMAND_DECLARE_FINAL_OPERATION (SetViewLayoutFinalOperation)

                    const Module &module;

                    explicit SetViewLayoutFinalOperation (const Module &module_) :
                        module (module_) {}
...
#endif // !defined (__thekogans_mex_core_command_SetViewLayoutFinalOperation_h)
