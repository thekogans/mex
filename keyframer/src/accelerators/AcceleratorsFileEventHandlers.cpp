...
namespace thekogans {
    namespace mex {
        namespace keyframer {
            ...
            //THEKOGANS_MEX_CORE_IMPLEMENT_COMMON_ACCELERATORS_ITEM_EVENT_HANDLER (AcceleratorsFileNewEventHandler, Keyframer)
            THEKOGANS_MEX_CORE_IMPLEMENT_COMMON_ACCELERATORS_ITEM_EVENT_HANDLER (AcceleratorsFileOpenEventHandler, Keyframer)
            //THEKOGANS_MEX_CORE_IMPLEMENT_COMMON_ACCELERATORS_ITEM_EVENT_HANDLER (AcceleratorsFileSaveEventHandler, Keyframer)
